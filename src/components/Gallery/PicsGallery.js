...
import GallerySidebar from './GallerySidebar.js';
...
const LandingPage = ()=>{
    return (
            ...
            <LandingPageContainer>
                ...
                <li data-depth="0.2" id="universe" className="layer">
                    <img src="./images/springgallery.png" alt="universe" />
                        
                    </li>
                    <li data-depth="0.5" id="planet" className="layer">
